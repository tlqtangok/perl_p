...
# jupyter lab --debug --config   /root/jd/t/jupyter_lab_config.py --allow-root
# jupyter lab --config   /root/jd/t/jupyter_lab_config.py --allow-root
c.ServerApp.ip = '0.0.0.0'
c.ServerApp.allow_remote_access = True
c.ServerApp.port = 10201
c.LabApp.workspaces_dir = '/root/jd/t/nb/ws'
c.ServerApp.root_dir = '/root/jd/t/nb'
c.ExtensionApp.open_browser = False
c.LabServerApp.open_browser = False
c.ServerApp.PasswordIdentityProvider.password_required = True
c.ServerApp.PasswordIdentityProvider.hashed_password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$3PHFNXQLhYPN8DpH+nfgwQ$BauxCoGu8Ajq11424HbAfmG8yz41xT82N6IqQqmRU3Y'
#c.ServerApp.password = 'argon2:$argon2id$v=19$m=10240,t=10,p=8$3PHFNXQLhYPN8DpH+nfgwQ$BauxCoGu8Ajq11424HbAfmG8yz41xT82N6IqQqmRU3Y'
##############
